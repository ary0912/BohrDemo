    ...
    <div ref={topbarRef} className="h-16 bohr-panel rounded-none border-0 flex items-center px-3 sm:px-4 md:px-8 justify-between relative shadow-sm bg-white/90 border-b border-slate-200" style={{ zIndex: 200 }}>
      <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-8 min-w-0">
        ...
        <button 
          ...
          className="lg:hidden w-10 h-10 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-600 hover:text-cyan-600 hover:bg-slate-100 hover:border-cyan-300 transition-all group active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500"
        >
        ...
        <div tabIndex={0} aria-label="Bohr Ops Home" className="flex items-center space-x-2 sm:space-x-3 group cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 rounded-lg p-1 -m-1">
        ...
        <div className="hidden lg:flex items-center space-x-4 md:space-x-8 pl-4 md:pl-8 border-l border-slate-200 shrink-0">
          <div className="flex flex-col">
            ...
            <div className="flex items-center space-x-1.5" aria-label="Mesh Status: Optimal" role="status">
              {[1, 2, 3, 4, 5].map(i => (
                <motion.div 
                  key={i}
      ...
      <div className="flex items-center space-x-2 sm:space-x-3 shrink-0">
        ...
        <button 
          ...
          className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-600 hover:text-cyan-600 hover:border-cyan-300 hover:bg-slate-100 transition-all shadow-sm active:scale-95 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500"
        >
